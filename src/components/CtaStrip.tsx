...
export default function CtaStrip() {
  return (
    <section
      className="relative overflow-hidden px-6 lg:px-10 py-28 flex flex-col items-center text-center border-b"
    ...
    >
      ...
      >
        <h2
          ...
          style={{ fontSize: "clamp(36px,5vw,68px)", letterSpacing: "-0.03em", lineHeight: 1 }}
        >
