...
export default function Ticker() {
  ...
  return (
    <section className="overflow-hidden border-b py-6" style={{ borderColor: "var(--border)" }}>
      <div
        className="flex gap-10 whitespace-nowrap font-head text-[clamp(28px,4vw,48px)] font-medium"
        style={{ willChange: "transform", animation: "tickerScroll 40s linear infinite" }}
      >
        {row.map((it, i) => (
