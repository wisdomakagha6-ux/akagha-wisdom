...
export const siteDescription =
  "AW. is a creative direction studio focused on brand systems, visual identity, AI marketing content generation, product experiences, and album artwork.";
export const siteAuthor = "AW.";
export const siteEmail = "akaghawisdom5@gmail.com";
